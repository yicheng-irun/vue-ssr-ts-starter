...
export default class ModelAdminBase {
     ...
     * data-list中拉取数据的函数
     */
    public getDataList: (req: DataListRequestBody, ctx: Context) => Promise<DataListResponseBody> = async () => {
     ...
     * edit-form中拉取数据的函数
     */
    public getEditData: (id: string, ctx: Context) => Promise<ModelDataItem> = async () => {
     ...
     * 移除某一项
     */
    public removeItem: (id: string, ctx: Context) => Promise<boolean> = async () => {
